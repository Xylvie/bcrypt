    ...
    <div class="container px-4 py-8 mx-auto">
        ...
        <div class="flex flex-col items-center space-y-4 md:flex-row md:justify-between md:space-y-0">
            ...
            <div class="flex gap-5">
                <a href="{{ route('buy', $coin['id']) }}">
                    <button class="px-5 py-2 text-xl font-bold bg-blue-500 rounded-md shadow-md hover:text-gray-700 hover:bg-blue-400">
                        Buy
                    </button></a>
                <a href="{{ route('sell', $coin['id']) }}">
...
@else
    <div class="flex items-center justify-center w-full h-screen">
        <h1 class="text-3xl font-bold text-center text-bold">Coin data is being rendered please refresh after a minute</h1>
    </div>
